...
Além do mais que quando você necessita fazer algo onde o motor não consegue te providenciar, você terá de depender de extensões antigas (algumas delas que você os fóruns oficiais falar sobre pode acabar nem exportando). Entre tudo isso eu acho que migrando de CTF pro Python faria meu projeto um ambiente mais confortável pra desenvolver 